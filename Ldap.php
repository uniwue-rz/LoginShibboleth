...
class Ldap
{
    ...
    {
        $this->user = PiwikConfig::getInstance()->shibboleth['user'];
        $this->password = PiwikConfig::getInstance()->shibboleth['password'];
        $this->host = PiwikConfig::getInstance()->shibboleth['host'];
        $this->port = PiwikConfig::getInstance()->shibboleth['port'];
        $this->dn = PiwikConfig::getInstance()->shibboleth['dn'];
    }
